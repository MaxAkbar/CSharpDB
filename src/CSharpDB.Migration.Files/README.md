...
inference with ordinal overrides and migration-catalog adaptation. The reader
handles quoted multiline fields and escaped quotes without loading the source
file into memory, preserves exact decoded text, and keeps null, empty, missing,
...
Tolerant rejects, migration data-source adaptation, prepared target writes,
durable resume, manifests, and export are later Phase 4 slices.
