...
/// <summary>
/// Versioned MySQL facts added to catalogs bound to one provider-neutral
/// retained row package.
/// </summary>
public static class MySqlRetainedDataContract
{
...
/// <summary>
/// Caller-selectable bounds for a retained MySQL capture. Values can narrow
/// the fixed implementation ceilings but cannot raise them.
/// </summary>
public sealed record MySqlRetainedCaptureOptions
{
    ...
    {
        ValidateBound(nameof(MaxTables), MaxTables, MaximumTables);
        ValidateBound(
