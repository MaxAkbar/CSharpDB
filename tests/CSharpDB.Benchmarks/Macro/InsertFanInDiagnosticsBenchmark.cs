...
public static class InsertFanInDiagnosticsBenchmark
{
        ...
        bool recordLatencies)
    {
        ...
        for (int writerIndex = 0; writerIndex < scenario.WriterCount; writerIndex++)
        {
            ...
            writerTasks[writerIndex] = Task.Run(async () =>
            {
                ...
                {
                    string sql = BuildInsertSql(localWriterIndex, scenario.IdMode);
    ...
    private static string BuildInsertSql(int writerIndex, InsertIdMode idMode)
    {
        return idMode == InsertIdMode.ExplicitId
            ? $"INSERT INTO bench (id, value, text_col, category) VALUES ({Interlocked.Increment(ref _nextExplicitId)}, {writerIndex}, 'insert_fan_in', 'Alpha')"
