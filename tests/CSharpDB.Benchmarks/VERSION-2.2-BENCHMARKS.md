...
Captured: March 20, 2026 (branch `version2.2.0`)
...
`c2.2_test` reflects the local benchmark run captured on March 20, 2026.

### CSharpDB SQL (file-backed)

| Metric | v2.0 | v2.2 | c2.2_test | Delta |
|--------|------|------|-----------|-------|
| Single INSERT | **17.7K** ops/sec | **28.9K** ops/sec | **24.5K** ops/sec | **+63.2%** |
| Batched INSERT | **~417.6K** rows/sec | **~701.0K** rows/sec | **~649.9K** rows/sec | **+67.9%** |
| Point Lookup (cold) | **~38.0K** ops/sec | **~31.0K** ops/sec | **~30.9K** ops/sec | **-18.4%** |
| Concurrent Reads (8r) | 112,913 / 1,854,122 | 1,066,690 / 8,034,923 | 388,750 / 8,052,332 | **+844% / +333%** |

### CSharpDB SQL (in-memory)

| Metric | v2.0 | v2.2 | c2.2_test | Delta |
|--------|------|------|-----------|-------|
| Single INSERT | **~285.6K** ops/sec | **~358.0K** ops/sec | **~349.2K** ops/sec | **+25.3%** |
| Batched INSERT | **~951.7K** rows/sec | **~1.45M** rows/sec | **~1.28M** rows/sec | **+52.2%** |
| Point Lookup (cold) | **~604.2K** ops/sec | **~508.9K** ops/sec | **~455.0K** ops/sec | **-15.8%** |

### CSharpDB Collection (file-backed)

| Metric | v2.0 | v2.2 | c2.2_test | Delta |
|--------|------|------|-----------|-------|
| Single Put | **21.3K** ops/sec | **30.7K** ops/sec | **26.6K** ops/sec | **+44.1%** |
| Batched PUT | **~290.7K** docs/sec | **~403.6K** docs/sec | **~417.7K** docs/sec | **+38.8%** |
| Point Get (cold) | **~37.2K** ops/sec | **~31.8K** ops/sec | **~30.4K** ops/sec | **-14.5%** |

### CSharpDB Collection (in-memory)

| Metric | v2.0 | v2.2 | c2.2_test | Delta |
|--------|------|------|-----------|-------|
| Single Put | **~413.6K** ops/sec | **~519.3K** ops/sec | **~289.7K** ops/sec | **+25.6%** |
| Batched PUT | **~809.9K** docs/sec | **~932.9K** docs/sec | **~863.9K** docs/sec | **+15.2%** |
| Point Get (cold) | **~596.3K** ops/sec | **~597.7K** ops/sec | **~538.5K** ops/sec | **+0.2%** |
